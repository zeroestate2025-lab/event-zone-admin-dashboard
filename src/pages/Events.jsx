  ...
  const handleSearchChange = (e) => {
    ...
    if (searchValue === '') {
      ...
      const filtered = partners.filter((partner) =>
        partner.businessName.toLowerCase().includes(searchValue.toLowerCase())
      );
            ...
            <div className="modal-content">
              {loading ? (
                ...
                <div className="empty-state">
                  ...
                  <p>{searchTerm ? 'No partners found matching your search' : 'No partners available for this category'}</p>
                </div>
              ) : (
                <div className="partners-grid">
                  {filteredPartners.map((partner) => {
                    return (
                      <div key={partner.id} className="partner-card-simple">
                        <div className="partner-card-image-wrapper">
                          {partner.images && partner.images.length > 0 ? (
                            ...
                            <div className="partner-card-image-placeholder">
                        ...
                        <div className="partner-card-content">
                          <h3 className="partner-card-name">{partner.businessName}</h3>
                          
                          <div className="partner-card-info">
                            <div className="partner-card-price">
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <line x1="12" y1="1" x2="12" y2="23"/>
                                <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>
                              </svg>
                              <span>₹{Number(partner.price).toLocaleString('en-IN')}</span>
                            </div>
